...
## Table of Contents
 ...
 - [Instructions to download project Github ](https://github.com/Global-Manu-Man/rn-montacargas-app.git)
...
- For example, if your HTML project is located at C:\xampp\htdocs\rn-montacargas-app, you can access it in your browser by typing http://localhost
...
```bash
  ...
  git clone https://github.com/Global-Manu-Man/rn-montacargas-app.git
...
![Logo](https://locallity-logos.s3.us-west-1.amazonaws.com/Screenshot_7.png)
