 ...
 var colorSheets = [
    ...
    function validate(email) {
        ...
        if (okvalide == true) {
            ...
            alert('mesagge' + "Correo invalido, agregue un correo valido."); 
        }
    ...
    //   Validate email and message ok  
        ...
        if (response.ok) {
            ...
            // Muestre un mensaje de error si la respuesta no es exitosa
...
//         // Coloque aquí el código para enviar los datos del formulario a Formspree.io
//         // Obtenga la URL del punto final de Formspree.io para su formulario
//      var formAction = document.querySelector('form').getAttribute('action');

//      // Envíe los datos del formulario a Formspree.io utilizando Fetch API
//      fetch(formAction, {
//      method: 'POST',
...
//       // Verifique si la respuesta es exitosa
//        if (response.ok) {
//       // Realice una acción específica después de enviar el formulario
//        console.log('Formulario enviado exitosamente');
//       } else {
//       // Muestre un mensaje de error si la respuesta no es exitosa
//        console.error('Error al enviar el formulario');
